import svgPaths from "./svg-zu55n1rr92";
  ...
  return (
    <div aria-label="Redo company logo" className="relative shrink-0 w-full" data-name="Logo">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pl-[32px] pr-[20px] py-[30px] relative size-full">
...
function Contents() {
  return (
    <div className="relative shrink-0 w-full" data-name="Contents">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <ol className="content-stretch flex flex-col gap-[10px] items-start pb-[30px] pl-[32px] pr-[20px] relative rounded-[inherit] size-full">
        ...
        <li className="relative shrink-0">
          <button aria-label="Redirect to typography section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] size-full text-left whitespace-nowrap" data-name="Link">
            <div className="flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
              <p className="leading-[1.2]">The Module</p>
            </div>
            <div className="flex flex-col justify-center relative shrink-0 text-[#575757] text-[10px] tracking-[-0.2px]">
        ...
        <li className="relative shrink-0">
          <button aria-label="Redirect to art direction section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] size-full text-left whitespace-nowrap" data-name="Link">
            <div className="flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
              <p className="leading-[1.2]">The Grid</p>
            </div>
            <div className="flex flex-col justify-center relative shrink-0 text-[#575757] text-[10px] tracking-[-0.2px]">
        ...
        <li className="content-stretch flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] relative shrink-0 whitespace-nowrap" data-name="Link">
          <div className="flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
            <p className="leading-[1.2]">Imagery</p>
          </div>
          <div className="flex flex-col justify-center relative shrink-0 text-[#575757] text-[10px] tracking-[-0.2px]">
            <p className="leading-[1.2]">07</p>
          </div>
        </li>
        <li className="content-stretch flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] relative shrink-0 whitespace-nowrap" data-name="Link">
          <div className="flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
            <p className="leading-[1.2]">Illustrations</p>
          </div>
          <div className="flex flex-col justify-center relative shrink-0 text-[#575757] text-[10px] tracking-[-0.2px]">
            <p className="leading-[1.2]">08</p>
          </div>
        </li>
      </ol>
    </div>
...
function Hero() {
  return <div aria-label="Logo on colored background" className="bg-[rgba(0,0,0,0.1)] h-[540px] shrink-0 w-full" data-name="Hero" />;
}
...
function List() {
  return (
    <ol className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-w-px relative" data-name="List">
      <List1 />
      <List2 />
      <List3 />
      <List4 />
    ...
    <section aria-label="Table of contents" className="h-[426px] relative shrink-0 w-full" data-name="Table of contents">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[32px] items-start pb-[120px] pt-[32px] px-[32px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px relative text-[30px] text-black tracking-[-0.6px]">
...
function Title() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-end min-w-px relative" data-name="Title">
...
function BrandPositioningDesignPrinciples() {
  return (
    <section className="content-stretch flex flex-col items-start pb-[120px] pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="Brand Positioning & Design Principles">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header />
    </section>
  );
...
function Title1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-end min-w-px relative" data-name="Title">
...
function Img() {
  return <div aria-label="Image of primary brand logo" className="aspect-[966/500.09246826171875] bg-[rgba(0,0,0,0.1)] shrink-0 w-full" data-name="IMG" />;
}
...
function Img1() {
  return <div aria-label="Image of brand logo in clearspace" className="aspect-[464/240] bg-[rgba(0,0,0,0.1)] shrink-0 w-full" data-name="IMG" />;
}
...
function Img2() {
  return <div aria-label="Image of secondary brand logo" className="aspect-[966/500] bg-[rgba(0,0,0,0.1)] shrink-0 w-full" data-name="IMG" />;
}
...
function Item() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-w-px relative" data-name="Item 1">
      <Img3 />
      <Label />
    </div>
  );
...
function Item1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-w-px relative" data-name="Item 2">
      <Img4 />
      <Label1 />
    </div>
  );
...
function Item2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-w-px relative" data-name="Item 3">
      <Img5 />
      <Label2 />
    </div>
  );
...
function Logo1() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-center pb-[120px] pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="Logo">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header1 />
      <LogoDiagrams />
    </section>
...
function Img9() {
  return <div aria-label="Large letters in brand typography" className="aspect-[467/300] bg-[rgba(0,0,0,0.1)] shrink-0 w-full" data-name="IMG" />;
}

function Content2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[40px] items-start justify-center min-w-px relative" data-name="Content">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#575757] text-[15px] tracking-[-0.15px] w-full">
      ...
      <Img9 />
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#575757] text-[0px] tracking-[-0.15px] w-full whitespace-pre-wrap">
        <p className="mb-0 text-[15px]">
          <span className="leading-[1.2]">{`Primary typeface `}</span>
          <span className="font-['Rethink_Sans:Medium',sans-serif] font-medium leading-[1.2] text-[#152ae8] tracking-[-0.15px]">(Alyamama)</span>
          <span className="leading-[1.2]">{` carries the journalism and editorial voice. It is used for headlines, body text, pull quotes, and display numerals.`}</span>
        </p>
        <p className="leading-[1.2] mb-0 text-[15px]">​</p>
        <p className="text-[15px]">
          <span className="leading-[1.2]">{`Secondary typeface `}</span>
          <span className="font-['Rethink_Sans:Medium',sans-serif] font-medium leading-[1.2] text-[#152ae8] tracking-[-0.15px]">(Changa)</span>
          <span className="leading-[1.2]">{` carries the system and the interface language. It is used for verdict tags, type cards, navigation labels, dates, and bylines.`}</span>
        </p>
      </div>
    </div>
  );
...
function Secondary() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Secondary">
      ...
      <p className="font-['Changa:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[60px] text-right tracking-[-1.2px] w-full" dir="auto">
        أ ب ت ث ج ح خ د ذ ر ز س ش ص ض ط ظ ع غ ف ق ك ل م ن ه و ي
      </p>
      <p className="font-['Changa:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[60px] text-right tracking-[-1.2px] w-full" dir="auto">
        ٠ ١ ٢ ٣ ٤ ٥ ٦ ٧ ٨ ٩
...
function SectionHeader4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Section header">
      <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[22px] text-black tracking-[-0.22px] whitespace-nowrap">
...
function Header3() {
  return (
    <div className="content-stretch flex gap-[64px] h-[182px] items-start py-[32px] relative shrink-0 w-full" data-name="Header">
      ...
      <SectionHeader4 />
      <div className="flex flex-[1_0_0] flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px relative text-[#575757] text-[15px] tracking-[-0.15px]">
...
function Content3() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start pb-[10px] relative shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Alyamama:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[50px] text-black tracking-[-1px] w-[546px]">Clear Up Confusion, Gain Peace of Mind</p>
      <Description />
    </div>
  );
}
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start py-[10px] relative shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Alyamama:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[32px] text-black tracking-[-0.64px] w-[654px]">Whether it’s a bank error, an unauthorized charge, or an overlooked refund, we ensure you don’t pay for something you shouldn’t have.</p>
      <Description1 />
    </div>
  );
}
...
function Content6() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start pb-[10px] relative shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="font-['Changa:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[14px] text-black w-[517px]">Financial errors shouldn’t slow you down or cause unnecessary stress. Whether it’s an incorrect charge, a duplicate transaction, or a miscalculated fee, we step in to make things right. Our process is simple, straightforward, and designed to get your money back where it belongs—quickly and without hassle.</p>
      <Description3 />
    </div>
  );
}
...
function TypeStyles() {
  return (
    <div className="relative shrink-0 w-full" data-name="Type styles">
      <div className="content-stretch flex flex-col gap-[100px] items-start px-[32px] relative size-full">
        <Styles />
        <Sizing />
      </div>
    </div>
...
function Typography() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-start pb-[120px] pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="Typography">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header2 />
      <TypeStyles />
    </section>
...
function Header4() {
  return (
    <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full" data-name="Header">
      <Title3 />
      <div className="flex flex-[1_0_0] flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px relative text-[#575757] text-[0px] tracking-[-0.15px]">
        <p className="leading-[1.2] text-[15px] whitespace-pre-wrap">
...
function Img10() {
  return <div aria-label="Orange color swatch" className="bg-[#152ae8] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
  ...
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Blue</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #152AE8</p>
      </div>
    </div>
  );
}
...
function Img11() {
  return <div aria-label="Blue tint color swatch" className="bg-[#040404] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Img12() {
  return (
    <div aria-label="White color swatch" className="bg-white flex-[1_0_0] min-h-px relative rounded-[100000px] w-full" data-name="IMG">
...
function Label8() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      ...
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #FFFFFF</p>
      </div>
    </div>
  );
}
...
function Colors() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Colors">
      <Color />
      <Color1 />
      <Color2 />
    </div>
...
function SectionHeader6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Section header">
      <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.22px] whitespace-nowrap">
        <h3 className="block leading-[1.2] text-[22px]">Accent Palette</h3>
      </div>
    </div>
  );
}
...
function Img13() {
  return <div aria-label="Navy color swatch" className="bg-[#f5423d] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label9() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Red</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #F5423D</p>
      </div>
    </div>
  );
}
...
function Img14() {
  return <div aria-label="Blue color swatch" className="bg-[#24e285] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label10() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Lime Green</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #24E285</p>
      </div>
    </div>
  );
}
...
function Img15() {
  return <div aria-label="Sky blue color swatch" className="bg-[#fea8cd] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label11() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Pink</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #FEA8CD</p>
      </div>
    </div>
  );
}
...
function Img16() {
  return <div aria-label="Off-blue color swatch" className="bg-[#fbd769] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label12() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Yellow</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #FBD769</p>
      </div>
    </div>
  );
}
...
function ColorRow() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Color row 1">
      <Color3 />
      <Color4 />
      <Color5 />
      <Color6 />
...
function SectionHeader7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Section header">
      <div className="flex flex-col font-['Rethink_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.22px] whitespace-nowrap">
        <h3 className="block leading-[1.2] text-[22px]">Verdict Palette</h3>
      </div>
    </div>
  );
}
...
function Img17() {
  return <div aria-label="Navy color swatch" className="bg-[#940278] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label13() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Fabricated Purple</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #940278</p>
      </div>
    </div>
  );
}
...
function Img18() {
  return <div aria-label="Blue color swatch" className="bg-[#b00035] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label14() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Inaccurate Maroon</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
...
function Img19() {
  return <div aria-label="Sky blue color swatch" className="bg-[#ff6524] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label15() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Misleading Orange</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #FF6524</p>
      </div>
    </div>
  );
}
...
function Img20() {
  return <div aria-label="Off-blue color swatch" className="bg-[#ffcc26] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label16() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Clarification Yellow</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #FFCC26</p>
      </div>
    </div>
  );
}
...
function Img21() {
  return <div aria-label="Deep orange color swatch" className="bg-[#e9e9e9] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function Label17() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[4px] items-start leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full" data-name="Label">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Correct Grey</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p className="leading-[1.2] text-[13px]">Hex: #E9E9E9</p>
      </div>
    </div>
  );
}
...
function Img22() {
  return <div aria-label="Black color swatch" className="bg-[#040404] flex-[1_0_0] min-h-px rounded-[100000px] w-[229.5px]" data-name="IMG" />;
}
...
function Img23() {
  return (
    <div aria-label="Dark grey color swatch" className="bg-white flex-[1_0_0] min-h-px relative rounded-[100000px] w-full" data-name="IMG">
      <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[100000px]" />
    </div>
  );
}
...
function Img24() {
  return <div aria-label="Grey color swatch" className="bg-[#152ae8] flex-[1_0_0] min-h-px rounded-[100000px] w-full" data-name="IMG" />;
}
...
function ColorRow2() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Color row 2">
      <Color11 />
      <Color12 />
      <Color13 />
      <Color14 />
...
function ColorSystem() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-start pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="Color System">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header4 />
      <ColorPalette />
    </section>
...
function TheModuleSystem() {
  return (
    <div aria-label="Section 2 out of 6" className="content-stretch flex flex-col gap-[30px] items-start pb-[120px] pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="The Module System">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header5 />
      <Img25 />
    </div>
...
function Text2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Text">
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#575757] text-[15px] tracking-[-0.15px] w-[492px] whitespace-pre-wrap">
...
function GridSpecifications() {
  return (
    <div aria-label="Section 2 out of 6" className="content-stretch flex flex-col gap-[30px] items-start pb-[120px] pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="Grid Specifications">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header6 />
      <Img26 />
      <Text2 />
...
function Header7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Header">
      <div className="content-stretch flex gap-[32px] items-start pt-[20px] px-[32px] relative size-full">
        <Title6 />
        <div className="flex flex-[1_0_0] flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px relative text-[#575757] text-[15px] tracking-[-0.15px]">
...
function Image() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-w-px relative" data-name="Image 1">
      <Image1 />
      <Description4 />
    </div>
  );
...
function Image2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-w-px relative" data-name="Image 2">
      <Image3 />
      <Description5 />
    </div>
  );
...
function Imagery() {
  return (
    <section className="content-stretch flex flex-col gap-[65px] items-start pb-[120px] relative shrink-0 w-[1030px]" data-name="Imagery">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header7 />
      <PhotoGrid />
    </section>
...
function Illustrations() {
  return (
    <section className="content-stretch flex flex-col gap-[65px] items-start pb-[120px] relative shrink-0 w-[1030px]" data-name="Illustrations">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header8 />
      <PhotoGrid1 />
    </section>
...
function Main() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Main">
      <Hero />
      <Main1 />
    </div>
  );
